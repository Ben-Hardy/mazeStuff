...
public
  ...
  // Creates a new maze. Usually this will be done by reading in info from a
  // file
public
  void instantiateMaze(int[][] newMaze, int xDim, int yDim, int sx, int sy,
                       int fx, int fy) {
    ...
    // Mark the start and finish points differently so that they can be easily
    // spotted
